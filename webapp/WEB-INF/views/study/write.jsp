...
<body>
	<div id="container">
		...
		<div id="content">
			<div id="study">
				<!-- <form class="study-form" method="post" action="${pageContext.request.contextPath}/study/upload"> -->
				<form id = "study-form" class = "study-form" action="${pageContext.request.contextPath}/study/upload" method="post"
					...
					<div class="bottom">
						<a href="${pageContext.request.contextPath}/study">취소</a> <input type="submit" value="등록">
					</div>
				</form>
			</div>
		</div>
